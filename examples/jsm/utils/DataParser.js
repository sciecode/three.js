...
var DataParser = function ( buffer, offset, littleEndian ) {
...
DataParser.prototype = {
	...
	getString: function ( bytes ) {
		...
		var string = LoaderUtils.decodeText( new Uint8Array( this.dataView.buffer, this.offset, bytes ) );
		this.offset += bytes;
		return string;
	...
	getNullTerminatedString: function () {
		...
		var string = LoaderUtils.decodeText( new Uint8Array( this.dataView.buffer, this.offset, stringOffset ) );
